var food = new Phaser.Class({
    ...
    create: function ()
    {
        ...
        this.num1.on('pointerdown',function(){this.classifyImage(this.num1, this.num2, this.operation.text, this.answer.text)},this);
        ...
        this.num2.on('pointerdown',function(){this.classifyImage(this.num2, this.num1, this.operation.text, this.answer.text)},this);
