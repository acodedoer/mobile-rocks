var petmenu = new Phaser.Class({
    ...
    {   
        ...
        let button_countdown = new ButtonLink({scene:this,x:window.innerWidth/4,y:window.innerHeight/2, sprite:'button_countdown', link:"petcountdown"}).setScale(this.game.global.scaler).setOrigin(0.5);
