var wordsfixed = new Phaser.Class({
    ...
    function wordsfixed ()
    {
        Phaser.Scene.call(this, { key: 'wordsfixed' });
    },
    ...
    setScores(done){
        if (done==true){
            window.localStorage.setItem('wordsfixedtime', this.second_counter);
            if(window.localStorage.getItem('wordsfixedtime')<=this.second_counter){
                window.localStorage.setItem('wordsfixedtime', this.second_counter);
            };  
        }
        window.localStorage.setItem('wordsfixedscore', this.count);
        if(window.localStorage.getItem('wordsfixedbestscore')<=this.count){
            window.localStorage.setItem('wordsfixedbestscore', this.count);
        };
    },

    done: function(){
        CameraPreview.hide()
        this.scene.start('wordsfixeddone')
    },

    gameOver: function(){
        CameraPreview.hide()
        this.scene.start('wordsfixedgameover')
    },
