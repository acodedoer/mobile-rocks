var petsfixedgameover = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

    function petsfixedgameover ()
    {
        Phaser.Scene.call(this, { key: 'petsfixedgameover' });
    },

    create: function () { 
        CameraPreview.hide()
        let score = window.localStorage.getItem('petsfixedscore');
        let best = window.localStorage.getItem('petsfixedscore');
