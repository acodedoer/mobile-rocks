var wordsmenu = new Phaser.Class({
    ...
    {   
        ...
        let button_timed = new ButtonLink({scene:this,x:window.innerWidth * 3/4,y:window.innerHeight/2, sprite:'button_timed', link:"wordsfixed"}).setScale(this.game.global.scaler).setOrigin(0.5);
    }
})